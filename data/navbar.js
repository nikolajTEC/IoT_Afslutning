...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function createNavbar() {
    // Skip creating navbar if accessed from 192.168.4.1 (this is the address for the AP)
    ...
    // Create navbar HTML - ensure all menu items are visible on all pages
    const navbarHTML = `
        ...
        <div class="container-fluid">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><a class="dropdown-item ${currentPage === 'delete_csv.html' ? 'active' : ''}" href="delete_csv.html">Delete CSV</a></li>
            </ul>
          </div>
        </div>
      </nav>
